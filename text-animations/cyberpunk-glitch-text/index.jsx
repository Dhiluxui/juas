...
export const GlitchEffectText = ({ 
  ...
  // Complex multi-layered glitch frames
  const redGlitch = {
    animate: {
      x: [0, -4, 4, -2, 2, 0, -3, 3, 0],
      y: [0, 2, -2, 1, -1, 0, 2, -2, 0],
  ...
  return (
    <div className="relative group cursor-pointer inline-block py-2 px-1 select-none">
      ...
      {/* Red Channel Glitch - Active heavily on hover */}
      <motion.h2
      ...
      {/* Cyan Channel Glitch - Active heavily on hover */}
      <motion.h2
      ...
      {/* Main Text - Idling and glitching slightly on hover */}
      <motion.h2 
