...
export interface CrystallineLightRefractionHeroProps extends React.HTMLAttributes<HTMLDivElement> {
  className?: string;
  children?: React.ReactNode;
}

export const CrystallineLightRefractionHero = ({ className = '', children, ...props }: CrystallineLightRefractionHeroProps) => (
