...
const shaderData = {
  ...
  fragment: `
    ...
    void main() {
      ...
      vec2 mouseOffset = (uMouse * 2.0 - uResolution.xy) / uResolution.y;
      float m = length(mouseOffset * 0.5);
      
      float wave = sin(r * 10.0 - uTime * 2.0 + a * 4.0);
      wave += cos(a * 8.0 + uTime);
      
      vec3 col = vec3(0.8, 0.2, 0.5) * (0.1 / abs(wave));
      col += vec3(0.2, 0.5, 0.9) * (0.05 / r);
...
export const MathArtPolarHero = ({ className = '', children, ...props }: any) => (
