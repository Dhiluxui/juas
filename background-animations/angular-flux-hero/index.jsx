...
const shaderData = {
  ...
  fragment: `
    ...
    void main() {
      ...
      float wave = sin(angle * 3.0 + uTime * 2.0 + radius * 5.0);
      float glow = 0.05 / abs(radius - (0.3 + wave * 0.1));
      
      vec3 color = vec3(0.2, 0.0, 0.5) * glow;
      color += vec3(0.1, 0.3, 0.6) * (1.0 - radius);
...
export const AngularFluxHero = ({ className = '', children, ...props }: any) => (
