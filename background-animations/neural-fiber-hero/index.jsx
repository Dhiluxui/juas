...
export interface NeuralFiberHeroProps extends React.HTMLAttributes<HTMLDivElement> {
  className?: string;
  children?: React.ReactNode;
}

export const NeuralFiberHero = ({ className = '', children, ...props }: NeuralFiberHeroProps) => (
  <div className={\`relative w-full h-full bg-[#020104] overflow-hidden font-sans \${className}\`} {...props}>
