...
const shaderData = {
  ...
  fragment: `
    ...
    void main() {
      ...
      float pattern = sin(a * 6.0 + uTime) * sin(r * 8.0 - uTime);
      float lines = smoothstep(0.3, 0.35, abs(pattern));
      
      vec3 color = vec3(0.05, 0.1, 0.2) + (lines * vec3(0.2, 0.6, 0.9));
      gl_FragColor = vec4(color, 1.0);
    }
  `
};

export const CrystalloidHero = ({ className = '', children, ...props }: any) => (
