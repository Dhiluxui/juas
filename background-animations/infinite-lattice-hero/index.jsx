  ...
  fragment: `
      ...
      void main() {
          ...
          for(int i = 0; i < 60; i++) {
              ...
              if(d < 0.1) {
                  float glow = 0.003 / (abs(d) + 0.001);
                  vec3 gridCol = 0.5 + 0.5 * cos(p * 2.0 + uTime);
                  col += gridCol * glow;
              }
          ...
          col = mix(col, vec3(0.0), smoothstep(0.0, 8.0, t));
...
export const InfiniteLatticeHero = ({ className = '', children, ...props }: any) => (
