...
export interface GoldenKifsHeroProps extends React.HTMLAttributes<HTMLDivElement> {
  className?: string;
  children?: React.ReactNode;
}

export const GoldenKifsHero = ({ className = '', children, ...props }: GoldenKifsHeroProps) => (
