...
const shaderData = {
  ...
  fragment: `
    ...
    void main() {
      ...
      float pulse = sin(r * 10.0 - uTime * 3.0);
      float flow = cos(a * 4.0 + uTime);
      
      vec3 col = vec3(0.5, 0.2, 0.9) * (0.02 / abs(r - 0.5 - pulse * 0.1 * flow));
      col += vec3(0.1, 0.8, 0.5) * (0.01 / abs(r - 0.3));
...
export const HarmonicVortexHero = ({ className = '', children, ...props }: any) => (
