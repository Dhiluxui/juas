...
const shaderData = {
  ...
  fragment: `
    ...
    void main() {
      vec2 uv = (gl_FragCoord.xy * 2.0 - uResolution.xy) / uResolution.y * 5.0;
      ...
      float vein = length(q + uv * 0.1);
      float lines = sin(vein * 10.0 - t * 2.0);
      
      vec3 color = vec3(0.0, 0.8, 0.4) * (0.05 / abs(lines));
      gl_FragColor = vec4(color, 1.0);
    }
  `
};

export const DataVeinsHero = ({ className = '', children, ...props }: any) => (
