...
export interface QuantumFoamHeroProps extends React.HTMLAttributes<HTMLDivElement> {
  className?: string;
  children?: React.ReactNode;
}

export const QuantumFoamHero = ({ className = '', children, ...props }: QuantumFoamHeroProps) => (
