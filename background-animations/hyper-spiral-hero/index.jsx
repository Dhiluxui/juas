...
const shaderData = {
  ...
  fragment: `
    ...
    void main() {
      ...
      float spiral = sin(a * 3.0 + r * 10.0 - uTime * 2.0);
      float glow = 0.05 / abs(r - 0.5 - 0.1 * spiral);
      
      vec3 col = vec3(0.1, 0.2, 0.5) * glow;
      col += vec3(0.4, 0.7, 0.9) * (0.02 / abs(r - 0.5));
...
export const HyperSpiralHero = ({ className = '', children, ...props }: any) => (
