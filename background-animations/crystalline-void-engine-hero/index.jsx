...
export interface CrystallineVoidEngineHeroProps extends React.HTMLAttributes<HTMLDivElement> {
  className?: string;
  children?: React.ReactNode;
}

export const CrystallineVoidEngineHero = ({ className = '', children, ...props }: CrystallineVoidEngineHeroProps) => (
  <div className={\`relative w-full h-full bg-[#030105] overflow-hidden font-sans \${className}\`} {...props}>
