...
const shaderData = {
  ...
  fragment: `
    ...
    void main() {
      ...
      float pulse = sin(a * 5.0 + uTime * 2.0) * 0.1;
      float val = 0.05 / abs(d - 0.5 + pulse);
      
      float distM = length(uv - m);
      float glow = 0.02 / (distM + 0.05);
      
      vec3 col = vec3(0.1, 0.2, 0.5) * val;
...
export const NeonPulseHero = ({ className = '', children, ...props }: any) => (
