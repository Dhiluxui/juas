...
const shaderData = {
  ...
  fragment: `
    ...
    void main() {
      ...
      float angle0 = uTime * 0.2;
      vec2 offset0 = vec2(cos(angle0), sin(angle0)) * 0.1;
      col.r = 0.02 / length(uv + offset0 * sin(d * 10.0 + uTime));
      
      float angle1 = uTime * 0.2 + 2.0;
      vec2 offset1 = vec2(cos(angle1), sin(angle1)) * 0.1;
      col.g = 0.02 / length(uv + offset1 * sin(d * 10.0 + uTime));
      
      float angle2 = uTime * 0.2 + 4.0;
      vec2 offset2 = vec2(cos(angle2), sin(angle2)) * 0.1;
      col.b = 0.02 / length(uv + offset2 * sin(d * 10.0 + uTime));
...
export const ChromaticPrismHero = ({ className = '', children, ...props }: any) => (
