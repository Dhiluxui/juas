...
export interface KineticWavesHeroProps extends React.HTMLAttributes<HTMLDivElement> {
  className?: string;
  children?: React.ReactNode;
}

export const KineticWavesHero = ({ className = '', children, ...props }: KineticWavesHeroProps) => (
