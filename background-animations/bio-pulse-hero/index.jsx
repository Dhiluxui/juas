...
const shaderData = {
  ...
  fragment: `
    ...
    void main() {
      ...
      float pulse = sin(r * 10.0 - uTime * 3.0) * 0.5 + 0.5;
      float rays = sin(a * 6.0 + uTime) * 0.5 + 0.5;
      
      float val = pulse * rays;
      vec3 color = vec3(0.0, 0.3, 0.2) * (1.0 - r);
      color += vec3(0.1, 0.9, 0.6) * val * (1.0 - r);
...
export const BioPulseHero = ({ className = '', children, ...props }: any) => (
