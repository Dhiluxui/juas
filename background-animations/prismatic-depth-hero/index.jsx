...
export interface PrismaticDepthHeroProps extends React.HTMLAttributes<HTMLDivElement> {
  className?: string;
  children?: React.ReactNode;
}

export const PrismaticDepthHero = ({ className = '', children, ...props }: PrismaticDepthHeroProps) => (
  <div className={`relative w-full h-full bg-[#0a0510] overflow-hidden font-sans ${className}`} {...props}>
