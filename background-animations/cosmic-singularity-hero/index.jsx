...
export interface CosmicSingularityHeroProps extends React.HTMLAttributes<HTMLDivElement> {
  className?: string;
  children?: React.ReactNode;
}

export const CosmicSingularityHero = ({ className = '', children, ...props }: CosmicSingularityHeroProps) => (
